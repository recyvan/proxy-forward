...
class TcpServer(threading.Thread):
    def __init__(self, server_port, usr_port):
...
if __name__ == '__main__':
    ...
    TcpServer(server_port=args.server_port, usr_port=args.user_port).run()
